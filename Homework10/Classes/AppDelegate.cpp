...
bool AppDelegate::applicationDidFinishLaunching() {
	...
	SpriteFrameCache::getInstance()->addSpriteFramesWithFile("level-sheet.plist");
	char _totalFrames1 = 8;
	char _frameName1[40];
	Animation* mouseAnimation = Animation::create();

	for (int i = 0; i < _totalFrames1; i++) {
		sprintf(_frameName1, "pulled-gem-mouse-%d.png", i);
		mouseAnimation->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName(_frameName1));
	}
